package com.android.floatingwindowmusic.services;
...
import com.android.floatingwindowmusic.FloatWindow;
import com.android.floatingwindowmusic.R;
import com.android.floatingwindowmusic.utils.ProgressTextUtils;

import java.io.IOException;

import static com.android.floatingwindowmusic.services.AudioState.STATE_PAUSE;
import static com.android.floatingwindowmusic.services.AudioState.STATE_PLAYING;
import static com.android.floatingwindowmusic.services.AudioState.STATE_PREPARE;
import static com.android.floatingwindowmusic.services.AudioState.STATE_READY;
import static com.android.floatingwindowmusic.services.AudioState.STATE_STOP;
...
public class MusicService extends Service implements PlayerInterface, View.OnClickListener, SeekBar.OnSeekBarChangeListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnBufferingUpdateListener {
    ...
    private String[] media_music_info = new String[]{ MediaStore.Audio.Media.DISPLAY_NAME,
...
//                res_names = this.getResources().getStringArray(R.array.res_names);
    ...
    private void initPlayRes() {
        ...
        dis_names = new String[cursor.getCount()];// 返回int的一个列
        res_names = new String[cursor.getCount()];
        for (int i = 0; i < cursor.getCount(); i++) {
            dis_names[i] = cursor.getString(0);
            res_names[i] = cursor.getString(1);
